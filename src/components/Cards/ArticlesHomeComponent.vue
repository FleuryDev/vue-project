<template>
    <div class="rounded-3xl  shadow-sm bg-gray-50 border e-card">
                            ...
                            <div id="" class=" relative -mt-16  p-3 pt-10  bg-gray-50 rounded-e-3xl rounded-es-3xl e-cardInfos text-black">
                            ...
                            <p class=" flex text-sm font-light text-black">
                                ...
                                </svg> {{article.location}}
                               </p>
                            <p class="mt-1 my-3"><span class="text-lg  text-black font-semibold ">{{article.prix}}</span> <span class="text-sm text-black font-light">Fcfa / mois</span></p>
                            <div class="text-gray-800  text-xs align-middle  justify-between font-medium  flex w-full my-auto"> 
                                ...
                                <span class="ml-2 my-auto font-extralight" translate="no">{{article.promoter}}</span> 
                                ...
                                <span class=" rounded-xl p-1 px-2 bg-orange-200 my-auto uppercase font-light">{{article.status}}</span>
                                </div>
                            </div>
                        </div>
</template>
...
export default {
    ...
    const options = {
      ...
      classes: {
		...
		arrows: 'splide__arrows bg-red-200 z-10',
		arrow : 'splide__arrow',
